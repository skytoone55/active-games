    ...
    <header className={`sticky top-0 z-40 ${theme === 'dark' ? 'bg-gray-900 border-gray-800' : 'bg-white border-gray-200'} border-b px-4 sm:px-6 py-4 shadow-md`}>
      <div className="flex items-center justify-between">
        ...
        {/* Navigation - Agenda, Clients, Commandes
             900px-1280px : icônes seules (compact) avec tooltip
             1280px+      : icônes + labels */}
        <div className="hidden min-[900px]:flex items-center gap-1 min-[1280px]:gap-3 flex-1 justify-center min-w-0">
          {hasPermission('agenda', 'can_view') && (
            ...
            >
              ...
              <span className="hidden min-[1280px]:inline">{t('admin.header.agenda')}</span>
          ...
          {hasPermission('clients', 'can_view') && (
            ...
            >
              ...
              <span className="hidden min-[1280px]:inline">{t('admin.header.clients')}</span>
          ...
          {hasPermission('orders', 'can_view') && (
            ...
            >
              ...
              <span className="hidden min-[1280px]:inline">{t('admin.header.orders')}</span>
              {/* Pastille rouge critique pour commandes en attente */}
              {hasPendingOrders && (
                <span className="absolute -top-1 -right-1 bg-red-600 text-white text-xs font-bold w-5 h-5 rounded-full flex items-center justify-center animate-pulse shadow-lg">
          ...
          {hasPermission('chat', 'can_view') && (
            ...
            >
              ...
              <span className="hidden min-[1280px]:inline">{t('admin.header.chat')}</span>
              {hasUnreadChats && (
          ...
          {hasPermission('calls', 'can_view') && (
            <Link
              ...
              className={`px-3 min-[1280px]:px-4 py-2 rounded-lg transition-colors flex items-center gap-2 ${
            ...
            >
              ...
              <span className="hidden min-[1280px]:inline">{t('admin.header.calls') || 'Appels'}</span>
            </Link>
          )}
        </div>
        ...
        <div className="hidden min-[900px]:flex items-center gap-2 flex-shrink-0">
          ...
          <div ref={langMenuRef} className="relative">
            ...
            >
              <Globe className="w-4 h-4 min-[1280px]:hidden" />
              <span>{languageFlags[locale].flag}</span>
              <ChevronDown className={`w-3 h-3 transition-transform hidden min-[1280px]:block ${showLanguageMenu ? 'rotate-180' : ''}`} />
            </button>
          ...
          <div ref={menuRef} className="relative">
            ...
            >
              ...
              <div className="text-left hidden min-[1280px]:block">
